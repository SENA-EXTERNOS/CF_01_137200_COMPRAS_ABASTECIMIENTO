  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 3
      h1 Métodos de valoración de inventarios
    ...
    figure
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/_xOOZhCVDtY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
      figcaption VIDEO
    ...
    .row.mt-5
      h3 Metodologías para la medición de existencias y el manejo de inventarios
    ...
    .row.center
      .tabla-a.color-acento-contenido 
        table
          thead
            tr
              th Sistema de inventario periódico
              th Sistema de inventario continuo
          tbody
            tr
              td.col-lg-12 
