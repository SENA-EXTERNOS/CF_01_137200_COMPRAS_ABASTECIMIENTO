...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    #t_2_1.titulo-segundo.color-black
      h2 2.1.	Elementos del sistema
    ...
    .row
      .col-md-4.mb-3
        img(src="@/assets/curso/temas/tema2/g2.svg", alt="Texto de la imagen")
      .col-md-8.mb-3
        p Emplear sistemas de información logística permitirá obtener un gran flujo de datos suministrados por los stakeholders de la organización, los cuales servirán para tomar decisiones, establecer un control y lograr una mejora continua respecto de los procesos logísticos, productivos y de inventarios.
        | Los sistemas de información logística están clasificados de acuerdo a las actividades o tareas que desarrolla, esto dependerá del proceso al cual se le quiera aplicar este tipo de tecnología. Por ejemplo, si la empresa necesita un SIL para desarrollar inconvenientes de varias áreas de la organización deberá emplear un programa horizontal, pero si se requiere desplegar ciertas actividades determinadas en un mismo departamento, se deberá acudir a un sistema vertical. 

      br
      h4 Software horizontal: 
      p comprende actividades básicas de ventas, gestión de documentos, facturas e inventarios.

      br
    
      h4 Software vertical:
      p tiene por objetivo desarrollar tareas de tipo logístico, inventarios de manera avanzada, proyección de la demanda, planeación estratégica de procesos, etc.

    Separador

    #t_2_2.titulo-segundo.color-black
      h2 2.2.	Importancia de las tecnologías
    ...
    #t_2_3.titulo-segundo.color-black
      h2 2.3.	Flujogramas de proceso de inventarios
